...
//    const forward_jump = !backward_jump && !is_source_code && pt1.x == pt2.x;
//    //if (forward_jump) {
...
function drawEdgeBetweenPoints(canvas, ctx, node1, node2, is_fallthrough, is_source_code)
{
    ...
    const forward_jump = !backward_jump && !is_source_code && node1.x == node2.x;
    //if (forward_jump) {
