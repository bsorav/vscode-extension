...
s441:
.LFB0:
	.file 1 "/home/himanshi/superopt-project/superopt-tests/TSVC_new/s441.c"
	.loc 1 4 2 view -0
	.cfi_startproc
	.loc 1 9 4 view .LVU1
.LBB2:
...
.L2:
	...
	.loc 1 11 6 view .LVU7
	.loc 1 12 12 view .LVU8
	.loc 1 13 6 view .LVU9
	.loc 1 15 6 view .LVU10
	.loc 1 15 11 is_stmt 0 view .LVU11
	movdqa	%xmm3, %xmm0
	movdqa	a(%eax), %xmm4
	.loc 1 11 19 view .LVU12
	movdqa	b(%eax), %xmm1
	addl	$16, %eax
	.loc 1 15 11 view .LVU13
	pcmpgtd	d-16(%eax), %xmm0
	.loc 1 11 19 view .LVU14
	pmulld	c-16(%eax), %xmm1
	.loc 1 11 11 view .LVU15
	paddd	a-16(%eax), %xmm1
	.loc 1 15 11 view .LVU16
	pblendvb	%xmm0, %xmm1, %xmm4
	.loc 1 13 19 view .LVU17
	movdqa	b-16(%eax), %xmm1
	.loc 1 15 11 view .LVU18
	movdqa	%xmm3, %xmm0
	pcmpeqd	d-16(%eax), %xmm0
	movdqa	%xmm4, %xmm2
	.loc 1 13 19 view .LVU19
	pmulld	%xmm1, %xmm1
	.loc 1 13 11 view .LVU20
	paddd	a-16(%eax), %xmm1
	.loc 1 15 11 view .LVU21
	pblendvb	%xmm0, %xmm1, %xmm2
	.loc 1 15 19 view .LVU22
	movdqa	c-16(%eax), %xmm1
	.loc 1 15 11 view .LVU23
	movdqa	d-16(%eax), %xmm0
	.loc 1 15 19 view .LVU24
	pmulld	%xmm1, %xmm1
	.loc 1 15 11 view .LVU25
	pcmpgtd	%xmm3, %xmm0
	paddd	a-16(%eax), %xmm1
	pblendvb	%xmm0, %xmm1, %xmm2
	movaps	%xmm2, a-16(%eax)
	.loc 1 9 29 is_stmt 1 view .LVU26
	.loc 1 9 20 view .LVU27
	cmpl	$128000, %eax
	jne	.L2
.LBE3:
	.loc 1 18 3 view .LVU28
	.loc 1 19 2 is_stmt 0 view .LVU29
	xorl	%eax, %eax
	ret
	.cfi_endproc
.LFE0:
...
.Letext0:
	...
	.file 9 "/home/himanshi/superopt-project/superopt-tests/TSVC_new/globals.h"
...
.string	"_IO_FILE"
.LASF66:
.string	"/home/himanshi/superopt-project/superopt-tests/TSVC_new/s441.c"
.LASF27:
.string	"_markers"
.LASF3:
...
.string	"_IO_save_end"
.LASF67:
.string	"/home/himanshi/superopt-project/superopt-tests/build/TSVC_new"
.LASF41:
.string	"__pad5"
.LASF43:
.string	"_unused2"
...
.ident	"GCC: (Ubuntu 8.4.0-7ubuntu3) 8.4.0"
.section	.note.GNU-stack,"",@progbits

`; 


export {srcCode, dstCode};